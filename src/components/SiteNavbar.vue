<template>
  ...
  >
    ...
    <template slot="start">
      ...
      <!-- Points at our own /courses rather than out to ptredu.org, which no
           longer resolves -- photonranch.org still links there and the tab is
           simply broken. The page says the material is still being written,
